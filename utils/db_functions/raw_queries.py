...
INSERT_QUERY_FOR_TIMESLOT = "INSERT INTO doctors_time_slot VALUES (nextval('doctors_time_slot_id_seq'),:day,:video," \
                            ":audio,:chat,:start_time,:end_time,:video_frequency,:audio_frequency,:chat_frequency," \
...
QUERY_FOR_EXISTING_TIMESLOT = "SELECT doctors_timeslot_map.doctor_id,doctors_time_slot.day," \
                              "doctors_time_slot.start_time,doctors_time_slot.end_time FROM doctors_time_slot INNER JOIN doctors_timeslot_map ON " \
                              "doctors_timeslot_map.time_slot_id=doctors_time_slot.id WHERE doctor_id=:doctor_id AND " \
                              "doctors_time_slot.day=:day "
